...
const float theta0 = -2.2;// theta del pendulo en equilibrio lo que muesta la IMU
...
float K[4]={3.0765  ,  7.1916 ,  -0.3560 ,  -1.0114};// vector K del controller -5+i*10 ;p2c=-5-i*10; p3c=-10+i*30 ; p4c=-10-i*30;
float L[4]={-0.0123, 0.0135, 0.0922 ,-0.0828};   // vector L del observer
...
//    matlab_send(angulo);
      ...
      byte * b1 = (byte *) &theta_dot  ;
      Serial.write(b1,4);
      //  
      byte * b2 = (byte *) &u_print;
      Serial.write(b2,4);
...
void moverGrados(float angulo){
  delay(1000);
  miServo.write(angulo);
  delay(1000);
  }

//----------------Funciones para mandar a simulink----------------
