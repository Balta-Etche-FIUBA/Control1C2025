...
const int periodo = 10;             //20ms de periodo del servo
...
const int periodoMuestreo = 10;   //cada cuanto tiempo se toman muestras en milisegundos
...
const float theta0 = 3;// theta del pendulo en equilibrio lo que muesta la IMU
...
float K[4]={-9,20 ,-1,0.5};// vector K del controller -4+-j2 -70+-j70
//float K[4]={-1.8208  , -6.8354 ,   1.9368  , -1.7658};// vector K del controller -5+-j5 -70+-j70
float L[4]={-0.002 , 0.0069 ,  0.24 , -0.21};   // vector L del observer

float A_fila1[4]={0.96, 0.37, -0.0004, -0.0006};// matriz A del observador Aodd
float A_fila2[4]={-0.1072,0.3307,-0.0058,0.0062};
float A_fila3[4]={1.5441,-23.2185,0.4504,0.5835};
float A_fila4[4]={-1.3676,20.5647,-0.5835,0.4504};

float B_fila1[2]= {    0.0003   -0.0023}; //matriz del observador Bodd
float B_fila2[2]= {  0.0049    ,0.0069};
float B_fila3[2]= {    0.4594  ,  0.2467};
float B_fila4[2]= {   0.9932   ,-0.2185};


float B_d[4]={0.0003 , 0.0049 , 0.4594, 0.9932};

float C_fila1[4]={ 3.7500  ,-6.6797 , 1.2360 ,  0};// matriz C del observer


float Cd[4]={-6.26 ,  94.1 ,   0 ,   0};// armado de theta estimada
...
//delay(10000);
  ...
  //moverServo(30);
    ...
    //Serial.print(B_fila1[0]);
//Serial.print(anguloMedido);
//Serial.print(" ,  ");
//Serial.print(B_fila1[1]);
//Serial.println(accion_ant);
//Serial.print(" ,  ");
//Serial.print(B_fila2[0]);
//Serial.print(" ,  ");
//Serial.print(B_fila2[1]);
//Serial.print(" ,  ");
//Serial.print(B_fila3[0]);
//Serial.print(" ,  ");
//Serial.print(B_fila3[1]);
//Serial.print(" ,  ");
//Serial.print(B_fila4[0]);
//Serial.print(" ,  ");
//Serial.println(B_fila4[1]);
...
//Serial.println(tiempoActual);
matlab_send(theta, theta_e,u_print);
...
xe[3]= (A_fila4[0]*xe_1[0]+ A_fila4[1]*xe_1[1]+A_fila4[2]*xe_1[2]+A_fila4[3]*xe_1[3]) + B_fila4[0]* (*u_1) + B_fila4[1]*theta ;
  ...
  float u = -0.62*( K[0]*xe[0]+K[1]*xe[1]+K[2]*xe[2]+K[3]*xe[3]);
